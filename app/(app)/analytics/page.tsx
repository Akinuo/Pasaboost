  ...
  if (scoreHistory.length === 0) {
    return (
      <div className="text-center py-20">
        ...
        <h2 className="text-xl font-display font-bold text-foreground mb-2">No data yet</h2>
  ...
  return (
    <div>
      ...
      {activeTab === 'scores' && (
        <motion.div className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div className="bg-card border border-border rounded-2xl p-5">
            <h3 className="font-display font-bold text-foreground mb-5">Total Score Over Time</h3>
      ...
      {activeTab === 'dimensions' && (
        <motion.div className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div className="bg-card border border-border rounded-2xl p-5">
            <h3 className="font-display font-bold text-foreground mb-5">All Dimensions Over Time</h3>
            <ResponsiveContainer width="100%" height={280}>
          ...
          {dimensionProgress.length > 0 && (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {dimensionProgress.map((dp) => (
                <div key={dp.dimension} className="bg-card border border-border rounded-xl p-4">
      ...
      {activeTab === 'writing' && (
        <motion.div className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          <div className="bg-card border border-border rounded-2xl p-5">
            <h3 className="font-display font-bold text-foreground mb-5">Score Distribution</h3>
          ...
          <div className="bg-card border border-border rounded-2xl p-5">
            <h3 className="font-display font-bold text-foreground mb-4">Essays by Exam Type</h3>
